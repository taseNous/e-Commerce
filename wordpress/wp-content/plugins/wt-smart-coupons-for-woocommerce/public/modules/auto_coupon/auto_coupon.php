...
class Wt_Smart_Coupon_Auto_Coupon_Public extends Wt_Smart_Coupon_Auto_Coupon_Common
{
     ...
     * @since 1.7.0 Non-BOGO coupons with a zero coupon amount are treated as invalid.
     */
    public function get_available_auto_coupons($return = "OBJECT", $offset = 0, $limit = 5 ) {       
        ...
        foreach ( $coupon_ids as $coupon_id ) {
            ...
            // Coupon amount is not a positive number and coupon type is not BOGO.
            if ( 0 >= $coupon_obj->get_amount() && ! $coupon_obj->is_type('wt_sc_bogo') ) {
                continue;
            }
